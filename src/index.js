...
Make sure to follow the user instructions. Do not include a title. Sign the poem with 'Intresting AI Poem' inside a <strong> element at the end of the poem and not at the beginning.`;
